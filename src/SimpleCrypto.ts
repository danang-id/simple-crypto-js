...
export class SimpleCrypto {
	...
	private _decrypt(): PlainData {
		...
		const salt = enc.Hex.parse(this._dataBuffer.substr(0, 32))
		const initialVector = enc.Hex.parse(this._dataBuffer.substr(32, 32))
	...
	public decrypt(cipher?: CipherText, secondArg?: boolean | Encoder, thirdArg?: boolean | Encoder): PlainData {
